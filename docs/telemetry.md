...
| `agent_model_id` | The Azure deployment chosen on Settings → General, e.g. `gpt-4o` |
...
`cap_agent_bridge`, `cap_cron_secret`, `cap_azure_openai`, `cap_google_oauth`, `cap_sso_provider`,
