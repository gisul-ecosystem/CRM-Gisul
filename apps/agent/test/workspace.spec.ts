...
const profile: WorkspaceProfile = {
	website: "trycomp.ai",
	narrative:
		"Gisul takes a startup from nothing to a SOC 2 or ISO 27001 audit by automating the evidence collection, and sells the platform on an annual subscription.",
	sections: {
...
describe("who we are", () => {
	...
	it("names us, and refuses to invent the rest", () => {
		...
		expect(markdown).toContain("Gisul");
